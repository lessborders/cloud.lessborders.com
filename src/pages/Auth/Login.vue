<template>
    <div class="page-container full-page d-flex col">
        ...
        <div class="col-12 col-lg-6 col-xl-5 text-center p-3 card-bg d-flex">
            <div class="small-container m-auto col pt-3 pb-5">
                ...
                <div class="mt-3 text-end">
                    <button @click="login" class="btn btn-primary">Sign in <i class="fa-regular fa-angle-right ms-1"></i></button>
                </div>
            </div>
        </div>
    </div>
